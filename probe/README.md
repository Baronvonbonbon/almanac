...
P6, P6b and P9 use the product's test-storage allowance. Every upload is random bytes encrypted under
a key that is thrown away — nothing readable leaves the phone. P6b stores 256 bytes through the host
itself, and names the account that paid by reading Bulletin's authorizations either side of it. P9a leaves one small statement that
