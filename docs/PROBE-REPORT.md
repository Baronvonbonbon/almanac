...
- [x] P9b and P9c on two phones — 2026-09-17: phone B found phone A's statement by topic. Worth
      re-running once to note whether the two phones are on **different accounts**, which P9c's output
      does not say and which R1 turns on
- [ ] P9's remaining half: how many statements one account really holds. DESIGN §9's budget of two —
      the sharing outbox and the backup pointer — rests on it, and three runs disagreed
