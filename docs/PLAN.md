...
- [x] Hearth, Moonpaper and Pebble, each light and dark, following the host theme; their fonts
      bundled, within a 400 KiB font budget separate from the code's — 242 KiB, and **489.1 KiB of
      code of 512** as of 2026-09-17, after Phase 4, Phase 5's Bulletin rails, and saying what the
      camera and a Bulletin upload are doing. 22.9 KiB of headroom
